...
<body>
	...
	while($row=mysqli_fetch_row($query))
	{
		echo "<tbody>";
		echo "<tr>";
			echo "<td><a href='generalledger.php?id=".$row[0]."'>".$row[0]."</a></td>";
			echo "<td><a href='generalledger.php?id=".$row[0]."'>".$row[1]."</a></td>";
			echo "<td><a href='generalledger.php?id=".$row[0]."'>".$row[2]."</a></td>";
			echo "<td>";
